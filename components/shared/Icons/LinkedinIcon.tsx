...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g clipPath="url(#a)">
      <g clipPath="url(#b)">
        <rect x={1} width={68} height={68} rx={14} fill="#FF3838" />
        <path fill="#F2FFFF" d="M1 0h68v68H1z" />
        <path fill="url(#c)" d="M-1.5 0h66v67h-66z" />
      </g>
    </g>
    <defs>
      <clipPath id="a">
        <rect x={0.5} width={64} height={64} rx={14} fill="#fff" />
      </clipPath>
      <clipPath id="b">
        <rect x={1} width={68} height={68} rx={14} fill="#fff" />
      </clipPath>
      <pattern
        id="c"
        ...
        height={1}
      >
        <use xlinkHref="#d" transform="matrix(.00198 0 0 .00195 -.008 0)" />
      </pattern>
      <image
        id="d"
        width={512}
